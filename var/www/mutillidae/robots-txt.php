...
<table style="margin-left:auto; margin-right:auto;width:600px;">
	...
	<tr>
		<td>
			...
			<a href="http://en.wikipedia.org/wiki/Robots_exclusion_standard">Robots Exclusion Standard</a>
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
</table>
			...
			<table>
				...
				<tr>
					<td class="hint-body">
						<ul class="hints">
							<li>
								Browse to the robots.txt file in Mutillidae
							</li>
							<li>
								Robots.txt is located at localhost/mutillidae/robots.txt
							</li>
							<li>
								Follow the paths in the robots.txt file
							</li>
				  		</ul>
					</td>
				</tr>
