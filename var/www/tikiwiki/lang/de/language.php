...
"JoinCapitalizedWords" => "GrosskleinW&ouml;rterZusammenschreiben",
...
"parent" => "parent",
"Unflagg" => "Kennzeichnung aufheben",
...
"Create a group for each user (with the same name as the user)" => "F&uuml;r jeden Benutzer eine eigene Gruppe anlegen (Gruppenname = Benutzername):",
...
"Displays user's contribution in the user information page" => "Zeigt die Nutzeraktivit&auml;t in MyTiki an",
...
"Protect email against spam" => "Vor Spam eMails sch&uuml;tzen",
...
// "General" => "Allgemein",
// "Graph appearance" => "Grafische Anzeige",
// "Camera settings" => "Kamera Einstellungen",
// "Physics engine" => "Physik-Engine",
"HTML in Wiki Pages" => "HTML in Wiki Seiten",
"Note: if you change this directory, you have to move the contents to the new directory. You can also use the 'Mover' below." => "Hinweis: wenn Sie das Verzeichnis &auml;ndern, m&uuml;ssen Sie den Inhalt in das neue Verzeichnis verschieben. Alternativ k&ouml;nnen Sie auch den 'Mover' unten verwenden.",
"Move images from filesystem storage to database storage" => "Verschiebe alle Bilder aus dem Dateisystem in die Datenbank",
"moved %s images, %s erros occured." => "%s Bilder verschoben, %s Fehler aufgetreten",
...
"Have your article commented" => "Benutzer kommentiert Ihren Artikel",
"Comment other user's blog" => "Blog eines anderen benutzers kommentieren",
"Have your blog commented" => "Benutzer kommentiert Ihren Blog",
...
"y" => "j",
"This user is not your friend" => "Dieser Benutzer ist nicht Ihr Freund",
...
"This is not a TikiWiki File. Check if this file was uploaded and if it is dangerous." => "Dies ist keine Tiki-Datei. Bitte &uuml;berpr&uuml;fen ob sie hochgeladen wurde und gef&auml;hrlich ist.",
...
"Bottom bar icons" => "Icons in der Fu&szlig;leiste anzeigen",
"Bottom bar debug" => "Server-Info in der Fu&szlig;leiste anzeigen",
...
// "Quatar" => "Quatar", // ## CLOSE: "quarter" => "Vierteljahr",
// "Romania" => "Romania",
...
"wiki page" => "Wiki-Seite", // ## CLOSE: "Wiki page" => "Wiki-Seite",
...
"cannot be found" => "wurde nicht gefunden",
"An error occured in a database query!" => "Fehler beim Zugriff auf die Datenbank!",
// "img-g" => "img-g",
...
"New article post: {\$mail_title} by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Neuer Artikel erschienen: {\$mail_title} von {\$mail_user} am {\$mail_date|tiki_short_datetime}", // ## CLOSE: "New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Neuer Blog-Eintrag: {\$mail_title}, \"{\$mail_post_title}\", von {\$mail_user} um {\$mail_date|tiki_short_datetime}",
...
"You can view the page by following this link:" => "Sie k&ouml;nnen die Seite betrachten in dem Sie diesem Link folgen:", // ## CLOSE: "You can edit the page following this link:" => "Sie k&ouml;nnen die Seite &uuml;ber diesen Link bearbeiten:",
...
"Wiki page %s changed" => "Die Wiki Seite %s wurde ge&auml;ndert", // ## CLOSE: "wiki pages changed" => "Wiki-Seiten ge&auml;ndert",
...
"v=view" => "v=betrachten", // ## CLOSE: "view" => "betrachten",
...
"Don't forget: to use feature you will need to enable it on" => "Um dieses Feature zu nutzen, aktivieren Sie es unter",
"Custom Code" => "Angepasster Code", // ## CLOSE: "Custom Home" => "Angepasstes Home",
"Custom code" => "Angepasster Code", // ## CLOSE: "Custom Home" => "Angepasstes Home",
...
"Use page description:" => "Seitenbeschreibung benutzen:", // ## CLOSE: "Use page description" => "Seitenbeschreibung benutzen",
"Site Search" => "Site Suche", // ## CLOSE: "Simple search" => "Einfache Suche",
...
"Note: This feature also requires phplayers to be turned on in Admin->Features" => "Hinweis: Um dieses Feature verwenden zu k&ouml;nnen, m&uuml;ssen PHPLayers unter Admin->Funktionen aktiviert sein.",
...
"Values are stored in a dedicated table for each tracker, then you can easily manipulate them outside TikiWiki" => "Die Werte f&uuml;r jeden Tracker werden in der seperaten Tabelle gespeichert, diese k&ouml;nnen ausserhalb von TikiWiki angepasst werden.",
...
"Error Log file" => "Fehler Log Datei",
...
"Edit Existing Forums" => "Vorhandene Foren bearbeiten", // ## CLOSE: "Edit existing forums" => "Vorhandene Foren bearbeiten",
...
"use wiki structure" => "Wiki Struktur benutzen",
...
// "Members" => "Members",
"assign permissions" => "Berechtigungen vergeben", // ## CLOSE: "Assign Permissions" => "Berechtigungen vergeben",
...
"Members List" => "Mitgliederliste", // ## CLOSE: "Member list" => "Mitgliederliste",
...
"CSV File" => "CSV Datei",
"Automatic Page Breaks" => "Automatischer Seitenumbruch",
...
"rebuild cache" => "Cache auffrischen",
// "XY-Size" => "XY-Size",
// "Bounding box" => "Bounding box",
"default scale" => "Standardskalierung",
// "Make Map" => "Make Map",
...
"TikiWiki Mods Configuration" => "TikiWiki Mod Konfiguration",
...
"s=source" => "s=Quellcode", // ## CLOSE: "Source" => "Quelle",
"b=rollback" => "b=Rollback", // ## CLOSE: "rollback" => "Rollback",
"No individual permissions; category or global permissions apply" => "Keine individuellen Berechtigungen; Kategorie oder globale Berechtigungen vergeben", // ## CLOSE: "No individual permissions global permissions apply" => "Keine individuellen Berechtigungen, globale Berechtigungen gelten",
...
"Help on Features Config" => "Feature-Konfigurations-Hilfe",
...
"Answers" => "Antworten", // ## CLOSE: "Answer" => "Antwort",
"add suggestion" => "Vorschlag hinzuf&uuml;gen",
"1 suggestion" => "1 Vorschlag",
"suggestions" => "Vorschl&auml;ge", // ## CLOSE: "Questions" => "Fragen",
...
"Site Identity features" => "Site Identit&auml;ts Features", // ## CLOSE: "User identity features" => "Benutzeridentit&auml;ts-Einstellungen",
...
"Channel" => "Channel",
"Ratio" => "Ratio",
"Height of top Heading" => "H&ouml;he der obersten &Uuml;berschrift",
"Height of mid Heading" => "H&ouml;he der mittlern &Uuml;berschrift",
"tbheight" => "Tabellenh&ouml;he",
"Name:" => "Name:",
"URL:" => "URL:",
"cType" => "cType",
"allow" => "allow",
...
"requested a reminder of the password for the" => "hat eine Passwort-Erinnerungsmail angefordert f&uuml;r ",
"requested a reset of the password for the" => "hat einen Passwort-Reset angefordert f&uuml;r",
"account" => "Account",
...
"This is only a temporary password. After you logged in with it, you will get to the 'change password' dialog." => "Dies ist nur ein tempor&auml;res Passwort. Nach dem Einloggen gelangen Sie in den 'Passwort &auml;ndern'-Dialog.",
...
"Banners" => "Banner",
"Edit templates" => "Vorlagen bearbeiten/betrachten",
"Admin drawings" => "Zeichnungen verwalten",
...
"GZIP Disabled" => "GZIP deaktiviert",
"GZIP Enabled" => "GZIP aktiviert",
...
"Distance" => "Entfernung zum Benutzer",
...
"Tag name" => "Tag Name",
"Restore the Wiki" => "Wikiseiten wiederherstellen",
...
// "Please expect not found help-pages with the default-URL. Any help with the documentation is welcome." => "Es kann vorkommen das Hilfe Seiten mit der Standard-URL nicht gefunden werden.<br/>Hilfe bei der Dokumentation ist erw&uuml;nscht.",
...
"use in cms" => "F&uuml;r Artikel anbieten",
"use in wiki" => "F&uuml;r Wiki-Seiten anbieten",
"use in newsletters" => "F&uuml;r Rundbriefe anbieten",
"use in HTML pages" => "F&uuml;r HTML-Seiten anbieten",
"template" => "Vorlage",
"Templates" => "Vorlagen",
...
"Field is hidden? (visible by admin only)" => "Feld versteckt? (nur f&uuml;r Admin sichtbar)",
...
"to" => "bis",
" to" => "R&uuml;ckverweise zu",
"No  to this page" => "Keine R&uuml;ckverweise auf diese Seite",
...
"edit image" => "Bildeinstellungen bearbeiten",
...
"Rendering Program Code" => "Quellcode-Formatierung",
...
"Removed version" => "L&ouml;schte Version",
"Viewed" => "betrachtet",
"Posted" => "gepostet",
"Uploaded" => "geuploaded",
...
"Theme is selected as follows" => "Das Theme wird folgenderma&szlig;en gew&auml;hlt",
"If a theme is assigned to the individual object that theme is used." => "Wenn ein Theme einem individuellem Objekt zugewiesen ist, wird diese verwendet",
"If not then if a theme is assigned to the object's category that theme is used" => "Wenn nicht, dann wird das Theme, das der Kategorie des Objekts zugewiesen ist gew&auml;hlt",
"If not then a theme for the section is used" => "Wenn nicht, dann wird das Theme des Bereichs gew&auml;hlt",
"If none of the above was selected the user theme is used" => "Wenn nicht, dann wird das Theme des Benutzers gew&auml;hlt",
"Finally if the user didn't select a theme the default theme is used" => "Trifft keiner der obenstehenden Punkte zu, dann wird das Default-Theme benutzt",
...
"Permission denied you cannot view  for this page" => "Zugriff verweigert. Sie k&ouml;nnen keine R&uuml;ckverweise f&uuml;r diese Seite ansehen",
...
"I did not understand what you said, please try again." => "Ich habe Sie leider nicht verstanden. Bitte wiederholen Sie.",
...
"View parsed by Text_Wiki" => "Seite mit Text_Wiki parsen",
"View parsed by Tikilib" => "Seite mit Tikilib parsen",
...
"Old Name" => "Alter Name",
"Please expect not found help-pages with the default-URL." => "Nicht alle Hilfe-Links werden funktionieren.",
"Any help with the documentation is welcome." => "&Uuml;ber &Uuml;nterst&uuml;tzung bei der Dokumentation freuen wir uns.",
"NOTE: Make sure to whitelist this domain to prevent<br />registration emails being canned by your spam filter!" => "Bitte schalten Sie diese Domain in ihrem Spamfilter frei, damit die Registrierungs-eMail auch ankommt!",
"advanced feature" => "Erweiterte Konfiguration",
"level configuration" => "Level-Konfiguration",
"country selector" => "L&auml;nderauswahl",
"item link" => "Link auf Objekt",
"item list" => "Objektliste",
"must be turned on and notification is sent to the admin's" => "m&uuml;ssen aktiviert sein, Nachricht bekommt der Administrator in seine",
...
"Administration features" => "Administrative Einstellungen",
"Transversal features" => "&Uuml;bergreifende Einstellungen",
"which apply to more than one section" => "Einstellungen, die sich auf mehrere Bereiche auswirken",
"Navigation features" => "Einstellungen zur Navigation",
"Look &amp; feel" => "Look &amp; Feel",
"themes" => "Themes",
"Text area features" => "Inhaltsbezogene Einstellungen",
"features you can use in all text areas, like wiki pages, blogs, articles, forums, etc" => "Einstellungen, die alle Textbereiche betreffen wie Wikiseiten, Blogs, Artikel, Foren etc.",
"Stats &amp; banners" => "Statistiken &amp; Banner",
"Crosslinks to other features and settings" => "Querverweise auf andere Funktionen und Einstellungen",
"host" => "Server",
"Tiki Unique Key" => "Eindeutiger Tiki-Schl&uuml;ssel",
"To add/remove calendars, look for \"Calendar\" under \"Admin\" on the application menu, or" => "Hinzuf&uuml;gen/L&ouml;schen von Kalendern unter 'Admin' / 'Kalender' im 'Men&uuml;', oder",
"Search and replace" => "Suchen und Ersetzen",
"file_galleries" => "Dateiarchive",
"user_messages" => "Benutzer-Nachrichten",
"newsreader" => "Newsreader",
"featured_links" => "Linkverzeichnis",
"html_pages" => "HTML-Seiten",
"mytiki" => "MyTiki",
"Future vers" => "Zuk&uuml;nft. Ver.",
"extwiki" => "externes Wiki",
"Use this repository as rule source for all your repositories based on doxygened docs. To setup yours just add new repository and copy rules from this repository :)" => "Benutzen Sie dieses Repository als Quelle f&uuml;r all ihre auf doxygen basierenden Repositories. Zum Aufsetzen einfach ein neues Repository erstellen und die Regeln reinkopieren. :)",
"perso" => "pers&ouml;nl.",
"Mods Configuration" => "MODs Einstellungen",
"mn" => "min",
...
"You also need to upload the <a target=\"_blank\" href=\"http://esup-phpcas.sourceforge.net/\">phpCAS library</a> separately to lib/phpcas/." => "Sie m&uuml;ssen zus&auml;tzlich die <a target=\"_blank\" href=\"http://esup-phpcas.sourceforge.net/\">phpCAS Bibliothek</a> nach lib/phpcas/ installieren.",
"Use of this feature is NOT recommended. Please use phpMyAdmin or mysqldump instead." => "Die Benutzung dieser Funktion wird nicht empfohlen. Wir verweisen auf phpMyAdmin und mysqldump.",
"To learn more about the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://workflow.tikiwiki.org\">Galaxia workflow engine</a>." => "Mehr &uuml;ber die <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://workflow.tikiwiki.org\">Galaxia Workflow Engine</a>.",
"An easier way to integrate content from another site into Tiki is via iframed links using Tiki's <a class=\"rbox-link\" href=\"tiki-admin_links.php\">featured links</a> feature." => "Ein einfacherer Weg um Inhalte anderer Tiki Sites zu integrieren ist der &uuml;ber Links in iframes durch Tiki's <a class=\"rbox-link\" href=\"tiki-admin_links.php\">Linktips</a> Funktion. Achtung: iframes k&ouml;nnen ein Sicherheitsproblem darstellen.",
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">themes</a>." => "Mehr &uuml;ber <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">Themes</a>.",
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tikiwiki.org\">mods</a>." => "Mehr &uuml;ber <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tikiwiki.org\">MODs</a>.",
"If your Tiki is acting weird, 1st thing to try it to clear your cache below. Also very important to clear your cache after an upgrade (by FTP/SSH if need be)." => "Wenn sich Tiki seltensam verh&auml;lt, sollten sie zuerst einmal den Cache l&ouml;schen. Dies ist auch besonders wichtig nach einer Aktualisierung von Tiki.",
"To <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://security.tikiwiki.org/tiki-contact.php\">report any security issues</a>." => "Probleme bez&uuml;glich Sicherheit bitte <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://security.tikiwiki.org/tiki-contact.php\">hier</a> melden.",
"To use menus in a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{menu id=x}{/literal}, where x is the ID of the menu. To use <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">phplayersmenu</a>, you can use one of the three following syntaxes:" => "Um Men&uuml;s in ein <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder eine Vorlage zu integrieren, benutzen Sie {literal}{menu id=x}{/literal}, wobei x die ID des Men&uuml;s ist. F&uuml;r <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">phplayersmenu</a> k&ouml;nnen Sie eine von drei Syntaxen verwenden:",
"This will work well (or not!) depending on your theme. To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">themes</a>" => "Dies wird funktionieren (oder nicht), abh&auml;ngig vom ausgew&auml;hlten Theme. Mehr zu Themes ist <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">hier</a> zu finden.",
"To use these links, you must assign the featured_links <a class=\"rbox-link\" href=\"tiki-admin_modules.php\"> module</a>." => "Um diese Links zu verwenden m&uuml;ssen Sie das <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> featured_links einem der Seitenbalken zuweisen.",
"To use cookie in a text area (Wiki page, etc), a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{cookie}{/literal}." => "Um Cookies (zuf&auml;llig aus einer Liste ausgew&auml;hlte Texte) in einen Text (Wiki Seite etc.), ein <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder eine Vorlage zu integrieren, benutzen Sie {literal}{cookie}{/literal}.",
"To create a drawing in a Wiki page, use {literal}{draw name=foo}{/literal}, where foo is the name of the drawing. After saving, click on the drawing link." => "Um eine Zeichnung in einer Wikiseite zu erstellen, benutzen Sie {literal}{draw name=foo}{/literal}, wobei foo der Name der Zeichnung ist. Klicken sie nach dem Speichern auf den Link zur Zeichnung.",
"To use content blocks in a text area (Wiki page, etc), a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{content id=x}{/literal}, where x is the ID of the content block." => "Um dynamische Inhalte in einen Text (Wiki Seite etc.), ein <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder eine Vorlage zu integrieren, benutzen Sie {literal}{content id=x}{/literal}, wobei x die ID des Content-Blocks ist ist.",
"To use a banner in a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{banner zone=ABC}{/literal}, where ABC is the name of the zone." => "Um Banner in ein <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder eine Vorlage zu integrieren, benutzen Sie {literal}{banner zone=ABC}{/literal}, wobei ABC der Name der Bannerzone ist.",
"Please see the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://dev.tikiwiki.org/tiki-index.php?page=Features\">evaluation of each feature</a> on Tiki's developer site." => "An <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://dev.tikiwiki.org/tiki-index.php?page=Features\">dieser</a> Stelle der Developer-Site k&ouml;nnen Sie eine qualitative Bewertung der einzelnen Funktionen einsehen.",
"To use RSS feeds in a text area (Wiki page, etc), a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{rss id=x}{/literal}, where x is the ID of the RSS feed."
=> "Um RSS Feeds in einen Text (Wiki Seite etc.), ein <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">Modul</a> oder eine Vorlage zu integrieren, benutzen Sie {literal}{rss id=x}{/literal}, wobei x die ID des RSS Feeds ist.",
"Post new message" => "neue Antwort erstellen",
