...
"New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Niu blog post: {\$mail_title}, \"{\$mail_post_title}\", wea {\$mail_user} hemi nao putum long {\$mail_date|tiki_short_datetime}",
