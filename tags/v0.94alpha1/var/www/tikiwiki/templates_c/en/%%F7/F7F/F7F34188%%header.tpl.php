...
smarty_core_load_plugins(array('plugins' => array(array('function', 'breadcrumbs', 'header.tpl', 32, false),array('function', 'popup_init', 'header.tpl', 142, false),array('modifier', 'escape', 'header.tpl', 36, false),array('modifier', 'asort', 'header.tpl', 125, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<link rel="alternate" type="application/rss+xml" title="RSS Articles" href="tiki-articles_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
...
<link rel="alternate" type="application/rss+xml" title="RSS Image Galleries" href="tiki-image_galleries_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
...
<link rel="alternate" type="application/rss+xml" title="RSS File Galleries" href="tiki-file_galleries_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
<?php endif;  if ($this->_tpl_vars['feature_forums'] == 'y' && $this->_tpl_vars['rss_forums'] == 'y' && $this->_tpl_vars['tiki_p_forum_read'] == 'y'): ?>
<link rel="alternate" type="application/rss+xml" title="RSS Forums" href="tiki-forums_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
<?php endif;  if ($this->_tpl_vars['feature_maps'] == 'y' && $this->_tpl_vars['rss_mapfiles'] == 'y' && $this->_tpl_vars['tiki_p_map_view'] == 'y'): ?>
<link rel="alternate" type="application/rss+xml" title="RSS Maps" href="tiki-map_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
<?php endif;  if ($this->_tpl_vars['feature_directory'] == 'y' && $this->_tpl_vars['rss_directories'] == 'y' && $this->_tpl_vars['tiki_p_view_directory'] == 'y'): ?>
<link rel="alternate" type="application/rss+xml" title="RSS Directories" href="tiki-directories_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_calendar'] == 'y' && $this->_tpl_vars['rss_calendar'] == 'y' && $this->_tpl_vars['tiki_p_view_calendar'] == 'y'): ?>
<link rel="alternate" type="application/rss+xml" title="RSS Calendars" href="tiki-calendars_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
<?php endif; ?>
