...
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'tiki.tpl', 19, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  if ($this->_tpl_vars['feature_bidi'] == 'y'): ?>
<div dir="rtl">
<?php endif; ?>
<div id="tiki-main">
  ...
  <?php if ($this->_tpl_vars['feature_left_column'] == 'user' || $this->_tpl_vars['feature_right_column'] == 'user'): ?>
    <tr><td id="tiki-columns" colspan="0" width="100%">
      ...
      <?php if ($this->_tpl_vars['feature_right_column'] == 'user'): ?>
        ...
        <img name="rightcolumnicn" class="colflip" src="img/icons/ofo.gif" border="0" alt="+/-" />&nbsp;<?php $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Show/Hide Right Menus<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>&nbsp;</a>
        </span>
      <?php endif; ?>
      <br />
    </td></tr>
...
?>
      ...
      <?php endif; ?>
      <td id="centercolumn" valign="top"><div id="tiki-center"><?php $_smarty_tpl_vars = $this->_tpl_vars;
