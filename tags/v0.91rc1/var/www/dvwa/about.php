...
<div class=\"body_padded\">
	...
	<p>Damn Vulnerable Web App (DVWA)<br />
	...
	<ul>
		...
		<li>Email: <a href=\"mailto:dvwa@dvwa.co.uk\">dvwa@dvwa.co.uk</a></li>
	...
	<p>Everyone is welcome to contribute and help make DVWA as successful as it can be.
		All contributors can have their	name and link (if they wish) placed in the credits section. Any feedback is welcomed.</p>
	
	<h2>Donate <img src=\"".DVWA_WEB_PAGE_TO_ROOT."dvwa/images/dollar.png\"></h2>
	
	<p>Have you found DVWA useful? Would you like to contribute to the project? Donate today and help DVWA expand! ".dvwaExternalLinkUrlGet( 'http://sourceforge.net/project/project_donations.php?group_id=263007','Donate' )."  </p>
	
	<h2>Sponsor us</h2>
	
	<p>Reach thousands of security professionals, web developers and students by sponsoring us. Place your organisations logo on the login page for maximum exposure. For more information email <a href=\"mailto:sales@dvwa.co.uk\">sales@dvwa.co.uk</a>.</p>
