...
<table width="100%" class="admin">
  ...
  <tr> {* beginning of mini calendar function option *}
      ...
      <td class="form"> {if $feature_help eq 'y'}<a href="{$helpurl}Maps" target="tikihelp" class="tikihelp" title="{tr}Maps{/tr}">{/if} 
{tr}Maps{/tr} {if $feature_help eq 'y'}</a>{/if}</td>
  ...
  <tr>
    ...
    <td class="form"> {tr}Show Babelfish Translation URLs{/tr} </td>
    </tr>
  <tr>
    ...
    <td class="form"> {tr}Show Babelfish Translation Logo{/tr} </td>
    </tr>
  <tr>
...
{tr}TikiSheet{/tr}">{/if} {tr}Tiki Sheet{/tr} {if $feature_help eq 'y'}</a>{/if}</td>
    ...
    <td class="form"> {if $feature_help eq 'y'}<a href="http://tikiwiki.org/InterTiki" target="tikihelp" class="tikihelp" title="{tr}tikiwiki.org help{/tr}: {tr}Intertiki{/tr}">{/if} {tr}Intertiki{/tr} {if $feature_help eq 'y'}</a>{/if}</td>
  </tr><tr>
    ...
    <td class="form"> {if $feature_help eq 'y'}<a href="{$helpurl}Blogs" target="tikihelp" class="tikihelp" title="{tr}tikiwiki.org help{/tr}: {tr}Trackbacks Pings{/tr}">{/if} {tr}Trackbacks Pings{/tr} {if $feature_help eq 'y'}</a>{/if}</td>
