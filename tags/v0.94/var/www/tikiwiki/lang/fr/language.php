...
"Company" => "Société",
"company" => "société",
"admin events template" => "administrer le gabarit des événements",
...
"Subscribe to event" => "S'inscrire à un événement",
"First Name:" => "Prénom :",
...
"to add/remove polls, look for \"Polls\" under \"Admin\" on the application menu, or" => "pour ajouter/supprimer des sondages , chercher \"Sondages\" sous \"Admin\" dans le menu général, ou",
"Communcation Center" => "Centre de communication",
"Gender" => "Gendre",
...
"Registered Currencies" => "Devises enregistrées",
...
"This is not a TikiWiki File. Check if this file was uploaded and if it is dangerous." => "Ce fichier n'est pas un fichier TikiWiki. Vérifier si ce fichier a été téléchargé et s'il est dangereux",
"File Gallery successfully added to the project." => "Succès de l'addition de la galerie de fichiers au projet.",
...
"DNS check failed for %s" => "La vérification DNS a échoué pour %s",
"Request failed for %s" => "La requête a échoué pour %s",
"Register" => "Inscrire",
"Approval?" => "Approuvé ?",
"Listed?" => "Listé ?",
"Examine" => "Examiner",
...
"Pending Registration" => "Inscriptions en attente",
...
"Approved?" => "Approuvé ?",
"Currencies Admin" => "Admininster devises",
...
"Please choose your project categories carefully. You can\nhowever change this later on your project admin panel." => "SVP, choisissez les catégories pour votre projet soigneusement. Vous pouvez cependant les changer par la suite dans le panneau admin->projet",
...
"Genre" => "Genre musical",
"Hide disabled sections" => "Cacher les sections désactivées",
...
"Project Object Created Successfully" => "L'objet projet a été créé avec succès",
"Project Name:" => "Nom du projet :",
"Project Description:" => "Description du projet:",
"Project Active" => "Activer un projet",
"Current Objects:" => "Objets courants :",
...
"Change text font" => "Changer la police de texte",
"Lists ''wanted'' Wiki pages" => "Listes de pages Wiki 'voulues'",
"Like pages" => "Pages similaires",
"Category: wiki, trackers, etc." => "Catégorie : wiki, trackers, etc.",
...
"New blog post: {\$mail_title}: {\$title} by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Nouveau message dans le blogue: {\$mail_title}: {\$title} par {\$mail_user} à {\$mail_date|tiki_short_datetime}",
...
"Please see the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://dev.tikiwiki.org/tiki-index.php?page=Features\">evaluation of each feature</a> on Tiki's developer site." => "SVP aller sur <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://dev.tikiwiki.org/tiki-index.php?page=Features\">évaluation de chaque fonctionnalité</a> sur le site développeur Tiki.",
"TikiTabs" => "Onglets Tiki",
"Use Quote plugin for quoting" => "Utilise le plugin QUOTE pour le texte auquel on répond",
"To use menus in a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{menu id=x}{/literal}, where x is the ID of the menu. To use <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">phplayersmenu</a>, you can use one of the three following syntaxes:" => "Pour utiliser un menu dans un <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> ou un gabarit, utiliser {literal}{menu id=x}{/literal}, où x est l'Id du menu. Pour utiliser un menu <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">PHPlayersmenu</a>, vous pouvez utiliser l'une des 3 syntaxes suivantes :",
...
"Your message has been sent to %d users" => "Votre mesage a été envoyé  %d users",
"No email was selected" => "Aucun email a été sélectionné",
"~np~{~/np~ARTICLES(max=>3,topic=>topicName,type=>type,categId=>Category parent ID)}{ARTICLES} Insert articles into a wikipage" => "~np~{~/np~ARTICLES(max=>3,topic=>NomSujet,type=>type,categId=>IdCatégorieParente)}{ARTICLES} Insère des articles dans une page wiki",
...
"Please see the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://doc.tikiwiki.org/tiki-index.php?page=Features\">evaluation of each feature</a> on Tiki's developer site." => "SVP, allez voir <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://doc.tikiwiki.org/tiki-index.php?page=Features\">évaluation de chaque fonctionnalité</a> sur le site des developpeurs de Tikiwiki.",
...
"Displays an alphabetically sorted list of registered users" => "Affiche une liste triée alphabétiquement des utilisateurs enregistrés",
