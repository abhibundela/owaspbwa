...
"idle" => "idle",
"URL cannot be accessed wrong URL or site is offline and cannot be added to the directory" => "L'URL non può essere verificato: l'URL èÂ¨ errato o il sito è offline e non può essere aggiunto alla galleria",
...
"This feature is disabled" => "Questa funzione èÂ¨disabilitata",
"Relevance" => "Rilevanza",
...
"secure" => "sicuro",
"stay in ssl mode" => "resta in modalitàÂ SSL",
"Tiki Logo" => "Logo Tiki",
"You have" => "Hai",
...
"Description" => "Descrizione",
"My Footnotes" => "Note a piè di pagina",
...
"URL already added to the directory. Duplicate site?" => "L'URL èÂ¨ giàÂ  presente nella galleria. Sito duplicato?",
