...
"The text in RED is" => "Teksten i rødt er",
"character(s) too long - please edit it." => "karakter(ne) er for lange - vær venlig at rette dem til.",
"Algeria" => "Algeret",
...
"Denmark" => "Danmark",
"Dominican_Republic" => "Dominicanske_Republik",
// "Ecuador" => "Ecuador",
"Egypt" => "Egypten",
...
"Slovakia" => "Slovakiet",
"Slovenia" => "Slovenien",
"Solomon_Islands" => "Salomon_�rne",
"Somalia" => "Somalien",
"South_Africa" => "Syd_Afrika",
"South_Korea" => "Syd_Korea",
"Spain" => "Spanien",
"Sri_Lanka" => "Sri_Lanka",
...
"Ukrainian" => "Ukrainsk",
// "Catalan" => "Catalan",
"This instance of activity is already complete" => "Denne indstands af aktivitet er allerede komplet",
"Fatal error: cannot execute automatic activity \$activityId" => "Fatal fejl: kan ikke udfre automatisk aktivitet \$activityId",
"Fatal error: setting next activity to an unexisting activity" => "Fatal fejl: s�ter n�te aktivitet til en ikke-eksisterende aktivitet",
"Fatal error: nextActivity does not match any candidate in autorouting switch activity" => "Fatal fejl: nextActivity matcher ikke nogen kandidat i autorouting switch aktivitet",
"Fatal error: non-deterministic decision for autorouting activity" => "Fatal fejl: ikke-bestemmelig beslutning til autorouting aktivitet",
"Fatal error: trying to send an instance to an activity but no transition found" => "Fatal fejl: prver p�at sende en indstands til en aktivitet, men ingen overgang fundet",
"Cannot add transition only split activities can have more than one outbound transition" => "Kan ikke tilfje overgang, kun delte aktiviteter kan have mere end en udg�nde overgang",
"Circular reference found some activity has a transition leading to itself" => "Cirkul� reference fundet. Nogen aktivitet har en overgang der peger p�sig selv.",
"Process does not have a start activity" => "Processen har ikke en start aktivitet",
"Process does not have exactly one end activity" => "Processen har ikke en egentlig afsluttende aktivitet",
"End activity is not reachable from start activity" => "Afsluttende aktivitet er ikke opn�lig fra start aktiviteten",
" is interactive but has no role assigned" => " er interaktiv men har ikke nogen rolle tilknyttet",
" is non-interactive and non-autorouted but has no role assigned" => " er ikke-interaktive og ikke-autorouted men har ingen rolle tilknyttet",
" is standalone but has transitions" => " er standalone men har overgange",
...
"Read an article" => "Læs en artikel",
"Publish an article" => "Publicer en artikel",
...
"Post in a blog" => "Skriv i en blog",
...
// "%H:%M %Z" => "%H:%M %Z",
"Friend" => "Ven",
"Last seen on " => "Sidst set den ",
"(idle for %s seconds)" => "(tomgang i %s sekunder)",
...
// "TikiSheet" => "TikiSheet",
"Sheet Heading" => "Ark overskrift",
"List wiki pages" => "List wiki sider",
"Last modified by" => "Sidst modificeret af",
...
"Split a page into rows and columns" => "Split en side op i rækker og kollonner",
"row1col1" => "ræk1kol1",
"row1col2" => "ræk1kol2",
"row2col1" => "ræk2kol1",
"row2col2" => "ræk2kol2",
"Run a sql query" => "Kør en sql forespørgsel",
...
"Newest first" => "Nyest først",
"Oldest first" => "Ældst først",
...
"Scale" => "Skala",
"Zoom out x4" => "Zoom ud x4",
"Zoom out x3" => "Zoom ud x3",
"Zoom out x2" => "Zoom ud x2",
"Query" => "Forespørgsel",
"Pan" => "Panorer",
"Zoom in x2" => "Zoom ind x2",
"Zoom in x3" => "Zoom ind x3",
"Zoom in x4" => "Zoom ind x4",
"Redraw" => "Gentegn",
...
"Side-by-side view" => "Side-om-side oversigt",
...
"Projects Menu" => "Projektmenu",
"Projects" => "Projekter",
"Register New Project" => "Register Nyt Projekt",
// "HomeworkMenu" => "HomeworkMenu",
"Homework" => "Hjemmearbejde",
"Assignments" => "Tilknytninger",
"Admin types" => "Admin typer",
"Create/Edit blog" => "Opret/tilret blog",
"Browse directory" => "Gennemse bibliotek",
"Maps" => "Kort",
"Layer management" => "Laghåndtering",
"List quizzes" => "List quizzer",
"List Courses" => "List kurser",
"ShtMenu" => "ShtMenu",
"Events" => "Hændelser",
"Send events" => "Send hændelser",
"Admin events" => "Admin hændelser",
...
"Please also see" => "Se venligst også",
...
"by modificator" => "af modifikator",
// "Skip to navigation" => "Skip to navigation",
// "left/right" => "left/right",
"Unassign module" => "Fjern modultilknytning",
"Edit mapfiles" => "Tilret kortfiler",
"Child" => "Barn",
"Add Page" => "Tilføj side",
"Translate in" => "Oversæt i",
"babelfish it" => "babelfish det",
"Welcome to" => "Velkommen til",
"Enlarge area height" => "Forstør område højde",
"Reduce area height" => "Reducer område højde",
"Jukebox" => "Jukebox",
"Meta Tags" => "Meta Tags",
"Site Identity" => "Site Identitet",
...
"Fields to display on page" => "Felter at vise på side",
"Expire Date" => "Udløbsdato",
"Visible" => "Synlig",
"Community settings" => "Community opsætning",
// "User identity features" => "User identity features",
// "Show user's info on mouseover" => "Show user's info on mouseover",
"Picture" => "Billed",
"Number of friends" => "Antal venner",
"E-mail" => "E-mail",
"Friendship network" => "Vennenetværk",
...
"PHPLayers" => "PHPLag",
"PhpLayers Dynamic menus" => "PhpLag Dynamiske menuer",
"JsCalendar" => "JsKalender",
"tikiwiki.org help" => "tikiwiki.org hjælp",
"TikiTabs" => "TikiTabs",
"Use Tabs" => "Bruger Tabs",
// "Tiki Sheet" => "Tiki Sheet",
"Multilingual" => "Multisproget",
"Best language" => "Bedste sprog",
"Site Logo and Identity" => "Site Logo og Identitet",
"Tiki Projects" => "Tiki Projekter",
"AutoLinks" => "AutoLinks",
"Contact Us (Anonymous)" => "Kontact Os (Anonymt)",
...
"Report all PHP errors" => "Rapporter alle PHP fejl",
...
"Mail end of line:" => "Mail slutning af linien:",
"(standard)" => "(standard)",
"(some Unix MTA)" => "(nogle Unix MTA'er)",
...
"Search features" => "Søgefaciliteter",
...
"unicode" => "unicode",
"was moved into trash" => "var flyttet til skraldespand",
"trashed by" => "smidt ud af",
"Rights by creator" => "Rettigheder sat af ",
"END" => "SLUT",
...
"NEW Task" => "NY Opgave",
"Changes on Task" => "Ændringer i Opgave",
// "You received a new task" => "You received a new task",
"The priority is" => "Proriteten er",
"very low" => "meget lav",
"low" => "lav",
"high" => "høj",
"very high" => "meget høj",
...
"New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user} at {\$mail_date|tiki_short_datetime}" => "Ny blog post: {\$mail_title}, \"{\$mail_post_title}\", af {\$mail_user} den {\$mail_date|tiki_short_datetime}",
