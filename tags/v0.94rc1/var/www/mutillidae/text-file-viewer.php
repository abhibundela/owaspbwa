...
?>
	...
	<option value="http://www.textfiles.com/hacking/atms">An Overview of ATMs and Information on the Encoding System
	</option>
	<option selected value="http://www.textfiles.com/hacking/auditool.txt">Intrusion Detection in Computers by Victor H. Marshall (January 29, 1991)
	</option>
	<option value="http://www.textfiles.com/hacking/backdoor.txt">How to Hold Onto UNIX Root Once You Have It
	</option>
	<option value="http://www.textfiles.com/hacking/hack1.hac">The Basics of Hacking, by the Knights of Shadow (Intro)
	</option>
	<option value="http://www.textfiles.com/hacking/hacking101.hac">HACKING 101 - By Johnny Rotten - Course #1 - Hacking, Telenet, Life
	</option>
	</select></p>
