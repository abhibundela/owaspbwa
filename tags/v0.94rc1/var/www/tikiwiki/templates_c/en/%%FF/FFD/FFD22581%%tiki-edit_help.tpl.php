<?php /* Smarty version 2.6.14, created on 2011-04-21 08:13:32
         compiled from tiki-edit_help.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tr', 'tiki-edit_help.tpl', 15, false),)), $this); ?>
...
<table width="100%">
<tr><td width="20%"><strong>Bold text:</strong></td><td> 2 underscores "_". Example: __text__</td></tr>
<tr><td width="20%"><strong>Italic text:</strong></td><td> 2 single quotes "'". Example: ''text''</td></tr>
<tr><td><strong>Centered text:</strong></td><td> 2 colons ":". Example: ::some text::</td></tr>
<tr><td><strong>Underlined text:</strong></td><td> 3 equals "=". Example: ===text===</td></tr>
<tr><td><strong>Text box:</strong></td><td> One carat "^". Creates a box with the data. Example: "^Box content^"</td></tr>
<tr><td><strong>Title bar:</strong></td><td> "-=title=-" creates a title bar.</td></tr>
<tr><td><strong>Colored text:</strong></td><td> "~~#FFEE33:some text~~" or  "~~yellow:some text~~". Will display using the indicated HTML color or color name</td></tr>
<tr><td><strong>Lists:</strong></td><td> * for bullet lists, # for numbered lists, ;term:definition for definiton lists</td></tr>
<tr><td><strong>Headings:</strong></td><td> "!", "!!", "!!!" make headings</td></tr>
...
<?php else: ?>
<tr><td><strong>Tables:</strong></td><td> "||row1-col1|row1-col2|row1-col3||row2-col1|row2-col2|row2-col3||" creates a table</td></tr>
<?php endif; ?>
<tr><td><strong>Images:</strong></td><td> "<?php echo '{'; ?>
img src=http://example.com/foo.jpg width=200 height=100 align=center imalign=right link=http://www.yahoo.com desc=foo alt=txt usemap=name class=xyz}" displays an image height width desc link and align are optional</td></tr>
...
<tr><td><strong>Horizontal rule:</strong></td><td>"-<em></em>-<em></em>-<em></em>-" makes a horizontal rule</td></tr>
...
?>
 <tr>
  ...
  <td><?php if ($this->_tpl_vars['plugins'][$this->_sections['i']['index']]['help'] == ''): ?>No description available<?php else:  echo $this->_tpl_vars['plugins'][$this->_sections['i']['index']]['help'];  endif; ?></td>
 </tr>
<?php endfor; endif; ?>
</table>
</div>
