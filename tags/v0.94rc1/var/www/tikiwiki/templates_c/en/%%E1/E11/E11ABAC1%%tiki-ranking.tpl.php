<?php /* Smarty version 2.6.14, created on 2011-04-21 08:20:40
...
<select name="limit">
<option value="10" <?php if ($this->_tpl_vars['limit'] == 10): ?>selected="selected"<?php endif; ?>>Top 10</option>
<option value="20" <?php if ($this->_tpl_vars['limit'] == 20): ?>selected="selected"<?php endif; ?>>Top 20</option>
<option value="50" <?php if ($this->_tpl_vars['limit'] == 50): ?>selected="selected"<?php endif; ?>>Top 50</option>
<option value="100" <?php if ($this->_tpl_vars['limit'] == 100): ?>selected="selected"<?php endif; ?>>Top 100</option>
</select>
...
"><?php if ($this->_tpl_vars['rankings'][$this->_sections['ix']['index']]['data'][$this->_sections['xi']['index']]['name'] == ""): ?>-<?php else:  echo $this->_tpl_vars['rankings'][$this->_sections['ix']['index']]['data'][$this->_sections['xi']['index']]['name'];  endif; ?></a></td><td  class="form" align="right"><?php if ($this->_tpl_vars['rankings'][$this->_sections['ix']['index']]['type'] == 'nb'):  echo $this->_tpl_vars['rankings'][$this->_sections['ix']['index']]['data'][$this->_sections['xi']['index']]['hits'];  else:  echo ((is_array($_tmp=$this->_tpl_vars['rankings'][$this->_sections['ix']['index']]['data'][$this->_sections['xi']['index']]['hits'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp));  endif; ?></td></tr>
<?php endfor; endif; ?>
</table>
</div>
</div>
