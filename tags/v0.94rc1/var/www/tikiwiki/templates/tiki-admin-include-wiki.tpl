...
{*    <input maxlength="20" size="10" type="text" name="wiki_forum" value="{$wiki_forum|escape}"/> *}
  ...
  <div class="cbox">
	...
	<td><input type="checkbox" name="wiki_3d_adjust_camera" {if $wiki_3d_adjust_camera eq 'true'}checked="checked"{/if} /></td>
      </tr>
      <tr>
	...
	<td><input type="text" name="wiki_3d_text_size" value="{$wiki_3d_text_size|default:"40"}" size="7" /></td>
      </tr>
      <tr>
	...
	<td><input type="text" name="wiki_3d_spring_size" value="{$wiki_3d_spring_size|default:"100"}" size="7" /></td>
      </tr>
      <tr>
