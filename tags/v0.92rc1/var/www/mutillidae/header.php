...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr><td bgcolor="#88ff88"align="center" colspan="2">
		<table width="100%">
		<td valign="top"><a href="index.php"><img border="0" align="top" src="images/coykillericon.png"></a><br>Version 1.5</td>
	...
	<tr>
		...
		<hr>
		<hr>
		<b><u>OWASP Top 10 2010</u></b><br>
		<hr>
		
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A1" target="_blank">A1</a> - Injection (SQL and Command)</b><p>
		...
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A2" target="_blank">A2</a> - Cross Site Scripting (XSS)</a></b><p>
		...
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A3" target="_blank">A3</a> - Broken Authentication and Session Management</a></b><p>
		<a href="index.php">Whole damn site</a><p>
		<a href="?page=login.php">Login</a><p>
		<a href="?page=user-info.php">User info</a><p>
		<hr>

		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A4" target="_blank">A4</a> - Insecure Direct Object References</b><p>
		<a href="?page=text-file-viewer.php">Text file viewer</a><p>
		<a href="?page=source-viewer.php">Source viewer</a><p>
		<a href="index.php">Whole damn site</a><p>
		<hr>

		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A5" target="_blank">A5</a> - Cross Site Request Forgery (CSRF)</b><p>
		<a href="?page=add-to-your-blog.php">Add to your blog</a><p>
		<a href="?page=view-someones-blog.php">View someone's blog</a><p>
		<a href="?page=show-log.php">Show log</a><p>
		<hr>

		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A6" target="_blank">A6</a> - Security Misconfiguration</b><p>
		<hr>
		<a href="index.php">Whole damn site</a><br>
		<hr>
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A7" target="_blank">A7</a> - Insecure Cryptographic Storage</a></b><p>
		<a href="?page=user-info.php">User info</a><p>
		<hr>
		
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A8" target="_blank">A8</a> - Failure to Restrict URL Access</a></b><p>
		...
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A9" target="_blank">A9</a> - Insufficient Transport Layer Protection</a></b><p>
		<a href="?page=login.php">Login</a><p>
		<a href="?page=user-info.php">User info</a><p>
		<hr>
		
		<b><a href="http://www.owasp.org/index.php/Top_10_2010-A10" target="_blank">A10</a> - Unvalidated Redirects and Forwards</b><p>
		<hr>
		<a href="?page=credits.php">Credits</a><br>	
<?php if ($_COOKIE["uid"]==1) { ?>		
		<a href="setupreset.php">Setup/reset the DB</a><br>
<?php } else { ?>
		Setup/reset the DB (Not logged in as Admin, so this is disabled)<br>
<?php }; ?>		
		<hr>
		<b><u>Items from the 2007 OWASP Top 10 that do not correlate to the 2010 list</u></b><br>
		<hr>
