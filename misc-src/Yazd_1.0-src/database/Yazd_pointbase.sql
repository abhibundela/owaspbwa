/* Ensure database is created with 8,192+ pagesize for the 
/* "YazdMessage" table.  You have to set the following property
/* in the "pointbase.ini" file to do this:
/*
/*	database.pagesize=8192
/* ============================================================ */
