...
<?php endif;  if ($this->_tpl_vars['lastup']): ?>
<div class="cvsup" style="font-size:x-small;text-align:center;color:#999;">Last update from CVS: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastup'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
</div>
<?php endif; ?>
</body>
</html>  