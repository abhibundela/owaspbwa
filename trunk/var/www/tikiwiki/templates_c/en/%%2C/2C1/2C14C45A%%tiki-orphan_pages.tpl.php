<?php /* Smarty version 2.6.14, created on 2011-04-21 08:20:36
...
<h1><a href="tiki-orphan_pages.php" class="pagetitle">Orphan Pages</a></h1>
...
<?php endif;  if ($this->_tpl_vars['wiki_list_hits'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">Hits</a></td>
<?php endif; ?>	
<?php if ($this->_tpl_vars['wiki_list_lastmodif'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'lastModif_desc'): ?>lastModif_asc<?php else: ?>lastModif_desc<?php endif; ?>">Last mod</a></td>
<?php endif;  if ($this->_tpl_vars['wiki_list_creator'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'creator_desc'): ?>creator_asc<?php else: ?>creator_desc<?php endif; ?>">Creator</a></td>
<?php endif; ?>	

<?php if ($this->_tpl_vars['wiki_list_user'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">Last author</a></td>
<?php endif; ?>	
<?php if ($this->_tpl_vars['wiki_list_lastver'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'version_desc'): ?>version_asc<?php else: ?>version_desc<?php endif; ?>">Last ver</a></td>
...
<?php endif;  if ($this->_tpl_vars['wiki_list_status'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'flag_desc'): ?>flag_asc<?php else: ?>flag_desc<?php endif; ?>">Status</a></td>
...
<?php endif;  if ($this->_tpl_vars['wiki_list_backlinks'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'backlinks_desc'): ?>backlinks_asc<?php else: ?>backlinks_desc<?php endif; ?>">Backlinks</a></td>
<?php endif;  if ($this->_tpl_vars['wiki_list_size'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-orphan_pages.php?find=<?php echo $this->_tpl_vars['find']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'size_desc'): ?>size_asc<?php else: ?>size_desc<?php endif; ?>">Size</a></td>
<?php endif; ?>
</tr>
