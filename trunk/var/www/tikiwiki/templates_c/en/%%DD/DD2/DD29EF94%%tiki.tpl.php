  ...
  <?php if ($this->_tpl_vars['feature_left_column'] == 'user' || $this->_tpl_vars['feature_right_column'] == 'user'): ?>
    <tr><td id="tiki-columns" colspan="0" width="100%">
      <?php if ($this->_tpl_vars['feature_left_column'] == 'user'): ?>
        ...
        <img name="leftcolumnicn" class="colflip" src="img/icons/ofo.gif" border="0" alt="+/-" />&nbsp;Show/Hide Left Menus&nbsp;</a>
        </span>
      <?php endif; ?>
      <?php if ($this->_tpl_vars['feature_right_column'] == 'user'): ?>
        <span style="float: right"><a class="flip" href="javascript:icntoggle('rightcolumn');">
        <img name="rightcolumnicn" class="colflip" src="img/icons/ofo.gif" border="0" alt="+/-" />&nbsp;Show/Hide Right Menus&nbsp;</a>
        </span>
      <?php endif; ?>
      <br />
    </td></tr>
