...
<?php
	...
	*/
	...
	// if we want to enforce GET method, we need to be careful to specify $_GET
   	...
   	if(strlen($lDocumentToBeFramed)==0){
		...
		<table style="margin-left:auto; margin-right:auto;">
			...
			<tr>
				<td style="text-align:left;">
					<input name="PathToDocument" id="id_path_to_document" type="radio" value="change-log.htm" checked="checked" />&nbsp;&nbsp;Change Log<br />
					<input name="PathToDocument" id="id_path_to_document" type="radio" value="installation.php" checked="checked" />&nbsp;&nbsp;Installation Instructions<br />
