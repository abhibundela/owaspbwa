...
mysql_query("DROP TABLE IF EXISTS " . $dbname . ".blogs_table" ,$conn);
echo mysql_error($conn) . "<br>";
...
mysql_query("DROP TABLE IF EXISTS " . $dbname . ".accounts" ,$conn);
echo mysql_error($conn) . "<br>";
...
mysql_query("DROP TABLE IF EXISTS " . $dbname . ".hitlog" ,$conn);
echo mysql_error($conn) . "<br>";
...
echo "<p>If you see no errors above OR only errors about dropping and creating the database, it should be done. <a href=\"index.php\">Continue back to the frontpage.</a>";
?>
</body>
</html>
