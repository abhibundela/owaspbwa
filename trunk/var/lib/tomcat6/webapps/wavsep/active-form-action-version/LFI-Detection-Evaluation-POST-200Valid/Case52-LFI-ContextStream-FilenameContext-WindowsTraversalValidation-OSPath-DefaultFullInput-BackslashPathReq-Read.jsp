...
<body>
	...
	<%
		...
		fileAccessMethod = FileAccessMethod.CONTEXT_STREAM;
		...
		accessRestriction = FileAccessRestriction.WINDOWS_TRAVESAL_INPUT_VALIDATION;
		...
		prefixRequired = PrefixRequirement.BACKSLASH_PREFIX;
